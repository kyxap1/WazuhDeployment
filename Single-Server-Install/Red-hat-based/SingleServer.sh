...
ELASTICSEARCH_URL=https://es.dev:443
...
curl https://raw.githubusercontent.com/wazuh/wazuh/3.13/extensions/elasticsearch/7.x/wazuh-template.json | curl -XPUT "$ELASTICSEARCH_URL/_template/wazuh" -H 'Content-Type: application/json' -d @-
...
/usr/share/kibana/bin/kibana-plugin install https://packages.wazuh.com/wazuhapp/wazuhapp-3.13.2_7.9.1.zip
